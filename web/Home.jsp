...
<html>
    ...
    <body>
        ...
        <div class="bingkaitengah"><br/>
            <div style="width:600px;
                 height:400px;
                 white-space:nowrap;
                 border:4px solid black;
                 background:url(Img/Icon.png) center ">
                <marquee behavior="scroll" direction="left" scrollamount="603" scrolldelay="2000" onmouseover="this.stop();"onmouseout="this.start();" >
                    <a href="#"><img src="Img/slide1.jpg" title="competence" width="600px" height="400px"/></a>
                    <a href="#"><img src="Img/slide2.jpg" title="conscience"width="600px" height="400px"/></a>
                    <a href="#"><img src="Img/slide3.jpg" title="compassion" width="600px" height="400px"/></a>
                    <a href="#"><img src="Img/slide4.jpg" title="sanata dharma" width="600px" height="400px"/></a>
                </marquee>
            </div>
            <br/>
        </div>
